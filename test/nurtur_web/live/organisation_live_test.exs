defmodule NurturWeb.OrganisationLiveTest do
  use NurturWeb.ConnCase
  ...
  describe "Show" do
    ...
    test "displays organisation", %{conn: conn, organisation: organisation} do
      {:ok, _show_live, html} = live(conn, Routes.organisation_show_path(conn, :show, organisation))
    ...
    test "updates organisation within modal", %{conn: conn, organisation: organisation} do
      {:ok, show_live, _html} = live(conn, Routes.organisation_show_path(conn, :show, organisation))
